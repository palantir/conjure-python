...
public final class PackagePrependingTypeNameProcessor implements TypeNameProcessor {

    private final PackageNameProcessor packageNameProcessor;

    public PackagePrependingTypeNameProcessor(PackageNameProcessor packageNameProcessor) {
